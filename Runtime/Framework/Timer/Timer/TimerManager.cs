...
#pragma warning restore CS0618 // 类型或成员已过时
    ...
    public void Register(Timer _timer)
    {
        ...
        _timer.onPause += () => { if (TimerManager.Inst.IsGlobalPause && _timer.State == EnumTimerState.Pause && !listLocalPasueTimer.Contains(_timer)) listLocalPasueTimer.Add(_timer); };
