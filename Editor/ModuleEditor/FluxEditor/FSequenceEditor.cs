            ...
            switch (Event.current.type)
            {
                ...
                case EventType.DragPerform:
                    ...
                    foreach (UnityEngine.Object obj in DragAndDrop.objectReferences)
                    {
                        ...
                        {
                            timeline.Add<FPlayParticleEvent>(new FrameRange(0, (int)ps.main.duration * Sequence.FrameRate));
                        }
                        else
                        {
                            timeline.Add<FSetActiveEvent>(new FrameRange(0, Sequence.Length / 4));
                        }
