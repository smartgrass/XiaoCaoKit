...
//		private SerializedProperty _containers = null;
		...
		private GUIContent _desLabel = new GUIContent("描述");
		private GUIContent _seqSettingLabel = new GUIContent("配置");
        void OnEnable()
		{
            ...
            _des = serializedObject.FindProperty("_des");
            _seqSetting = serializedObject.FindProperty("_seqSetting");
...
//			_containers = serializedObject.FindProperty("_timelineContainers");
		...
		public override void OnInspectorGUI ()
		{
            ...
            bool showContent = true; //Force Show
