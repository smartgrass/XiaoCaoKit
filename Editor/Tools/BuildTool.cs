...
namespace XiaoCaoEditor
{
    ...
    public static class BuildTool
    {
        ...
        [MenuItem(XCEditorTools.BuildYooRes)]
        public static void BuildYooRes()
        {
        ...
        [MenuItem(XCEditorTools.JustBuild)]
        public static void JustBuild()
        {


        }

        [MenuItem(XCEditorTools.CopyLubanConfig)]
        public static void CopyLubanConfig()
        {
            string buildDir = EditorPrefs.GetString("EditorBuildDir");
            if (string.IsNullOrEmpty(buildDir))
            {
                buildDir = "D:/Github/ActGame/Build";
            }
            CopyDir(buildDir);
        }
        ...
        static private void CopyDir(string buildDir)
        {
            string configDirName = "GameConfig";
            string tgtDir = Path.Combine(buildDir, configDirName);
